...
inductive TmState where
 ...
 | update_pv_X1 : TmState
 | skip_input : TmState
 | reset_visited_X0 : TmState
 | init_pv_stage_2 : TmState
 | cp_stage_4 : TmState
 | update_pv_stage_1 : TmState
 | divide_2_stage_4 : TmState
 | reset_visited : TmState
 | cp_stage_5 : TmState
 | divide_2_stage_5 : TmState
 | cp_stage_1 : TmState
 | init_pv_stage_1 : TmState
 | update_pv_stage_2 : TmState
 | divide_2_stage_6 : TmState
 | divide_2_stage_1 : TmState
 | finished_stage : TmState
 | reset_visited_X1 : TmState
 | update_pc_stage_2 : TmState
 | cp_stage_3 : TmState
 | init_pv_X0 : TmState
 | init_pv_stage_3 : TmState
 | cp_stage_6 : TmState
 | divide_2_stage_3 : TmState
 | init_pv_stage_4 : TmState
 | check_1_0X : TmState
 | continue_collatz_stage_1_0X : TmState
 | goto_input_and_plus_2 : TmState
 | update_pv_X0 : TmState
 | cp_twice_stage_7 : TmState
 | update_pc_stage_1 : TmState
...
| reset_visited_X0 => s!"           reset_visited_X0"
| divide_2_stage_4 => s!"           divide_2_stage_4"
| init_pv_stage_1 => s!"            init_pv_stage_1"
| pre_goto_input => s!"             pre_goto_input"
| finished_X1 => s!"                finished_X1"
| continue_collatz_stage_1 => s!"   continue_collatz_stage_1"
| goto_input_and_plus_2 => s!"      goto_input_and_plus_2"
...
| update_pv_X1 => s!"               update_pv_X1"
| update_pv => s!"                  update_pv"
| update_pv_stage_1 => s!"          update_pv_stage_1"
...
| divide_2_stage_5, Γ.zero => some ⟨init_pv_stage_1, ⟨Turing.Dir.left, Γ.zero⟩⟩
...
| update_visited_stage_2, Γ.one => some ⟨init_pv_stage_1, ⟨Turing.Dir.left, Γ.zero⟩⟩
| init_pv_stage_1, Γ.zero => some ⟨init_pv_stage_2, ⟨Turing.Dir.left, Γ.zero⟩⟩
| init_pv_stage_1, Γ.one => some ⟨init_pv_stage_1, ⟨Turing.Dir.left, Γ.one⟩⟩
| init_pv_stage_2, Γ.zero => some ⟨init_pv_stage_3, ⟨Turing.Dir.left, Γ.zero⟩⟩
| init_pv_stage_2, Γ.one => some ⟨init_pv_stage_2, ⟨Turing.Dir.left, Γ.one⟩⟩
| init_pv_stage_3, Γ.zero => some ⟨init_pv_stage_4, ⟨Turing.Dir.left, Γ.zero⟩⟩
| init_pv_stage_3, Γ.one => some ⟨unreachable, ⟨Turing.Dir.left, Γ.one⟩⟩
| init_pv_stage_4, Γ.zero => some ⟨init_pv_X0, ⟨Turing.Dir.left, Γ.zero⟩⟩
| init_pv_stage_4, Γ.one => some ⟨init_pv_X1, ⟨Turing.Dir.left, Γ.one⟩⟩
| init_pv_X0, Γ.zero => some ⟨pre_goto_input, ⟨Turing.Dir.right, Γ.zero⟩⟩
| init_pv_X0, Γ.one => some ⟨pre_goto_input, ⟨Turing.Dir.right, Γ.zero⟩⟩
| init_pv_X1, Γ.zero => some ⟨pre_goto_input, ⟨Turing.Dir.right, Γ.one⟩⟩
| init_pv_X1, Γ.one => some ⟨unreachable, ⟨Turing.Dir.right, Γ.one⟩⟩
...
| goto_input, Γ.one => some ⟨pre_goto_input, ⟨Turing.Dir.right, Γ.one⟩⟩
| goto_input_0X, Γ.zero => some ⟨skip_input, ⟨Turing.Dir.right, Γ.zero⟩⟩
| goto_input_0X, Γ.one => some ⟨goto_input, ⟨Turing.Dir.right, Γ.one⟩⟩
| skip_input, Γ.zero => some ⟨update_pc_stage_1, ⟨Turing.Dir.right, Γ.zero⟩⟩
| skip_input, Γ.one => some ⟨skip_input, ⟨Turing.Dir.right, Γ.one⟩⟩
| update_pc_stage_1, Γ.zero => some ⟨update_pc_stage_2, ⟨Turing.Dir.left, Γ.one⟩⟩
| update_pc_stage_1, Γ.one => some ⟨update_pc_stage_1, ⟨Turing.Dir.right, Γ.one⟩⟩
| update_pc_stage_2, Γ.zero => some ⟨finished_stage_1, ⟨Turing.Dir.left, Γ.zero⟩⟩
| update_pc_stage_2, Γ.one => some ⟨update_pv_stage_1, ⟨Turing.Dir.left, Γ.zero⟩⟩
| update_pv_stage_1, Γ.zero => some ⟨update_pv_stage_2, ⟨Turing.Dir.left, Γ.zero⟩⟩
| update_pv_stage_1, Γ.one => some ⟨update_pv_stage_1, ⟨Turing.Dir.left, Γ.one⟩⟩
| update_pv_stage_2, Γ.zero => some ⟨update_pv_X1, ⟨Turing.Dir.left, Γ.zero⟩⟩
| update_pv_stage_2, Γ.one => some ⟨update_pv_stage_2, ⟨Turing.Dir.left, Γ.one⟩⟩
| update_pv, Γ.zero => some ⟨update_pv_X0, ⟨Turing.Dir.left, Γ.zero⟩⟩
| update_pv, Γ.one => some ⟨update_pv_X1, ⟨Turing.Dir.left, Γ.one⟩⟩
| update_pv_X0, Γ.zero => some ⟨init_pv_stage_4, ⟨Turing.Dir.left, Γ.one⟩⟩
| update_pv_X0, Γ.one => some ⟨update_pv, ⟨Turing.Dir.left, Γ.one⟩⟩
| update_pv_X1, Γ.zero => some ⟨update_pv, ⟨Turing.Dir.left, Γ.zero⟩⟩
| update_pv_X1, Γ.one => some ⟨init_pv_stage_4, ⟨Turing.Dir.left, Γ.zero⟩⟩
| finished_stage_1, Γ.zero => some ⟨finished_X1, ⟨Turing.Dir.left, Γ.zero⟩⟩
| finished_stage_1, Γ.one => some ⟨finished_stage_1, ⟨Turing.Dir.left, Γ.one⟩⟩
| finished_stage, Γ.zero => some ⟨finished_X0, ⟨Turing.Dir.left, Γ.zero⟩⟩
| finished_stage, Γ.one => some ⟨finished_X1, ⟨Turing.Dir.left, Γ.one⟩⟩
| finished_X0, Γ.zero => some ⟨pre_check_1, ⟨Turing.Dir.right, Γ.zero⟩⟩
| finished_X0, Γ.one => some ⟨finished_stage, ⟨Turing.Dir.left, Γ.one⟩⟩
| finished_X1, Γ.zero => some ⟨finished_stage, ⟨Turing.Dir.left, Γ.zero⟩⟩
| finished_X1, Γ.one => none
...
| check_1, Γ.one => some ⟨continue_collatz_stage_1_1X, ⟨Turing.Dir.right, Γ.one⟩⟩
| check_1_0X, Γ.zero => some ⟨reset_visited_X1, ⟨Turing.Dir.left, Γ.zero⟩⟩
...
| continue_collatz_stage_1_1X, Γ.one => some ⟨continue_collatz_stage_1, ⟨Turing.Dir.right, Γ.one⟩⟩   -- never meet
...
| reset_visited, Γ.zero => some ⟨reset_visited_X0, ⟨Turing.Dir.left, Γ.zero⟩⟩
| reset_visited, Γ.one => some ⟨reset_visited_X1, ⟨Turing.Dir.left, Γ.zero⟩⟩
| reset_visited_X0, Γ.zero => some ⟨goto_input_and_plus_2, ⟨Turing.Dir.right, Γ.zero⟩⟩
| reset_visited_X0, Γ.one => some ⟨reset_visited, ⟨Turing.Dir.left, Γ.zero⟩⟩
| reset_visited_X1, Γ.zero => some ⟨reset_visited, ⟨Turing.Dir.left, Γ.zero⟩⟩
| reset_visited_X1, Γ.one => some ⟨reset_visited, ⟨Turing.Dir.left, Γ.zero⟩⟩                         -- never meet
| goto_input_and_plus_2, Γ.zero => some ⟨goto_input_and_plus_2, ⟨Turing.Dir.right, Γ.zero⟩⟩
| goto_input_and_plus_2, Γ.one => some ⟨plus_2, ⟨Turing.Dir.right, Γ.one⟩⟩
| plus_2, Γ.zero => some ⟨cp_stage_1, ⟨Turing.Dir.right, Γ.one⟩⟩
| plus_2, Γ.one => some ⟨plus_2, ⟨Turing.Dir.right, Γ.one⟩⟩
| unreachable , _ => none
